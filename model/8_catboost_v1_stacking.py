    ...
    def fit_predict(self, X_train, Y_train, X_test):
        ...
        for i, clf in enumerate(self.base_models):
            ...
            for j, (train_idx, test_idx) in enumerate(folds):
                ...
                if clf in [xgb1, xgb2, xgb3, xgb4, xgb5, lgb1, lgb2, lgb3, lgb4, lgb5, lgb6, lgb7, lgb8, SVM]:
...
lgb6 = LGBClassifier(lgb6_params)
...
lgb7 = LGBClassifier(lgb7_params)
...
lgb8 = LGBClassifier(lgb8_params)

params1 = {
    'booster': "gbtree",'objective': "binary:logistic",'eval_metric': "auc",
    'max_depth': 9,'subsample': 0.8,'colsample_bytree ': 0.9,'eta': 0.01,
    'lambda': 3,'silent': 1,'scale_pos_weight': 4,'min_child_weight': 1,'num_boost_round':2262}
xgb1 = XGBClassifier(params1)
params2 = {
    'booster': "gbtree",'objective': "binary:logistic",'eval_metric': "auc",
    'max_depth': 10,'subsample': 0.85,'colsample_bytree ': 0.9,'eta': 0.01,
    'lambda': 1,'silent': 1,'scale_pos_weight': 5,'min_child_weight': 1,'num_boost_round':2262}
xgb2 = XGBClassifier(params2)
params3 = {
    'booster': "gbtree",'objective': "binary:logistic",'eval_metric': "auc",
    'max_depth': 11,'subsample': 0.78,'colsample_bytree ': 0.85,'eta': 0.01,
    'lambda': 2,'silent': 1,'scale_pos_weight': 4,'min_child_weight': 2,'num_boost_round':2262}
xgb3 = XGBClassifier(params3)
params4 = {
    'booster': "gbtree",'objective': "binary:logistic",'eval_metric': "auc",
    'max_depth': 8,'subsample': 0.9,'colsample_bytree ': 0.9,'eta': 0.01,
    'lambda': 3,'silent': 1,'scale_pos_weight': 6,'min_child_weight': 2,'num_boost_round':2262}
xgb4 = XGBClassifier(params4)
params5 = {
    'booster': "gbtree",'objective': "binary:logistic",'eval_metric': "auc",
    'max_depth': 7,'subsample': 0.8,'colsample_bytree ': 0.88,'eta': 0.01,
    'lambda': 2,'silent': 1,'scale_pos_weight': 5,'min_child_weight': 1,'num_boost_round':2262}
...
# xgb2 = XGBClassifier(params2)
xgb_params={
    "learning_rate":0.01,"max_depth":5,"subsample":0.9,
    'colsample_bytree': 0.9,'objective': 'binary:logistic',
    'silent': 1, 'n_estimators':3000, 'gamma':1,
    'min_child_weight':1
}
xgb_all = xgb.XGBClassifier(**xgb_params, seed=2017)
cat1 = CatBoostClassifier(iterations=2580, loss_function='Logloss', eval_metric='AUC', od_type='Iter', od_wait=80, depth=10, nan_mode='Min',random_seed=2017,)
...
cat3 = CatBoostClassifier(iterations=3080, loss_function='Logloss', eval_metric='AUC', od_type='Iter', od_wait=80, depth=8, nan_mode='Min',random_seed=2017,)
...
cat5 = CatBoostClassifier(iterations=3880, loss_function='Logloss', eval_metric='AUC', od_type='Iter', od_wait=80, depth=7, nan_mode='Min',random_seed=2017,)
...
E = Ensemble(5, xgb_all, [lgb2, lgb3, lgb4, lgb5, lgb6, lgb7, lgb8, xgb1, xgb2, xgb3, xgb4, xgb5, lgb1, cat1, cat2, cat3, cat4, cat5])
